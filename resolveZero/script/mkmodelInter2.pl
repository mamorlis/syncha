...
my $usage = <<USG;
./mkmodelInter2.pl -m modelsPath -T {GA,WO,NI}
USG
...
system "$bactPath/bact_mkmodel -i $modelsPath/model_inter_0_${type} -o $modelsPath/model_inter_0_${type}.bin -O $modelsPath/model_inter_0_${type}.O";
